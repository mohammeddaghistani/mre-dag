...
# تصحيح الخطأ: تم تغيير unsafe_allow_index إلى unsafe_allow_html
st.markdown("""
    <style>
...
if not st.session_state.auth_success:
    st.markdown("<h1 class='main-title'>🏛️ دخول منصة إستدامة</h1>", unsafe_allow_html=True)
...
st.markdown("<center>منصة إستدامة | جميع الحقوق محفوظة 2026 ©</center>", unsafe_allow_html=True)
